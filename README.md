# 融资智研：基于智谱AI的企业融资风险中控服务软件 —— 比赛作品 Demo

本项目是一个面向26年全国大学生计算机设计大赛大数据主题赛：智能体赋能的企业运营分析与决策支持系统设计的**智能用户交互软件**，集成了自然语言对话、合规性检测、情感评估与行为预测等核心功能。系统以 Python 编写，拥有图形化界面（基于 PyQt / Tkinter 等），并支持将对话与分析结果导出为 PDF 报告。
